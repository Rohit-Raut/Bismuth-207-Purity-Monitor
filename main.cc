...
int main(int argc, char** argv)
{
    ...
    UImanager->ApplyCommand("/control/execute /Users/rohit/Research/Bismuth_sim/Bismuth-207-Purity-Monitor-Sim/vis.mac");
    //UImanager->ApplyCommand("/control/execute /Users/rohit/Research/Bismuth_sim/Bismuth-207-Purity-Monitor-Sim/run1.mac");
    ui->SessionStart();
    // delete runAction;
    // delete eventAction;
